...
Личная вики по машинному обучению. Каждая страница — самостоятельный разбор одной темы с выводом формул: генеративные модели, устройство трансформеров, прикладные детекторы и system design. Это и главная страница сайта, и индекс, по которому навыки `wiki-query` и `wiki-quiz` выбирают нужные страницы.
