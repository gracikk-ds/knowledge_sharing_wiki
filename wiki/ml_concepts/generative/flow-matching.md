...
Стаб. Текущая вики касается flow matching только как «instantaneous velocity»-бэйзлайна, на котором строятся [[methods/generative/shortcut-model]] и [[methods/generative/mean-flow]]:
